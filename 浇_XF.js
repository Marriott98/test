...
var account_list = ["188******31", "159******39", "han***@163.com", "264***@qq.com", "myu***@163.com"];
const cut_line = "==============================================================";
...
function main() {
    ...
    clean_reopen_alipay();
    cancel_up();
    switch_account(account_list[parseInt(random() * 5)]);
    check_depth();
    go_watering_xf(name);
...
function go_watering_xf(name) {
    ...
    goto_somewhere(name);
    sleep(1500);
    check_elements("展开好友动态", 1);
    toast_log("🚿🚿开始浇水~🚿🚿");
    for (var i = 0; i < 3; i += 1) {
        toast_log("🚿🚿第" + (i + 1) + "次🚿🚿");
        click(975 + random(-20, 20), 1890 + random(-20, 20));
        sleep(1500);
        click("66克");
        sleep(500);
        click("浇水送祝福");
